...
namespace SteamAudio
{
    ...
    public sealed class FMODStudioAudioEngineStateHelpers : AudioEngineStateHelpers
    {
        ...
        {
            var fmodStudioListener = (MonoBehaviour) GameObject.FindFirstObjectByType<StudioListener>();
        ...
        public override AudioSettings GetAudioSettings()
        {
            ...
            RuntimeManager.CoreSystem.getSoftwareFormat(out samplingRate, out speakerMode, out numRawSpeakers);

            uint frameSize = 0u;
            int numBuffers = 0;
            RuntimeManager.CoreSystem.getDSPBufferSize(out frameSize, out numBuffers);
